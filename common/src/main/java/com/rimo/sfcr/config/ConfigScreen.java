	...
	public Screen build() {
		...
		return builder.setParentScreen(MinecraftClient.getInstance().currentScreen)
				.setTitle(Client.isCustomDimensionConfig ?
						new TranslatableText("text.sfcr.title.customDimensionMode", dimensionName) :
						new TranslatableText("text.sfcr.title")
				)
				.setSavingRunnable(() -> {
				...
				.setFallbackCategory(builder.getOrCreateCategory(new TranslatableText("text.sfcr.category.general"))
						// Custom Dimension Warning
						.addEntry(builder.entryBuilder()
								.startTextDescription(new TranslatableText("text.sfcr.option.customDimensionMode.@PrefixText",
										"§b" + dimensionName
								))
						...
						.addEntry(builder.entryBuilder()
								.startTextDescription(new TranslatableText("text.sfcr.option.configHasBeenOverride.@PrefixText"))
						...
						.addEntry(builder.entryBuilder()
								...
								.setTextGetter(value -> value == 0 ?
										new TranslatableText("text.sfcr.disabled") :
				...
				.setFallbackCategory(builder.getOrCreateCategory(new TranslatableText("text.sfcr.category.clouds"))
						//cloud height
						.addEntry(builder.entryBuilder()
								...
								.setDefaultValue(192)
								.setTextGetter(value -> value < 0 ?
										new TranslatableText("text.sfcr.option.cloudHeight.followVanilla") :
						...
						//cloud color
						.addEntry(builder.entryBuilder()
								.startAlphaColorField(new TranslatableText("text.sfcr.option.cloudColor")
						...
						//dusk blush
						.addEntry(builder.entryBuilder()
								.startBooleanToggle(new TranslatableText("text.sfcr.option.enableDuskBlush")
										, CONFIG.isEnableDuskBlush())
								.setDefaultValue(true)
								.setTooltip(new TranslatableText("text.sfcr.option.enableDuskBlush.@Tooltip"))
								.setSaveConsumer(CONFIG::setEnableDuskBlush)
								.build())
						//bottomDim
						.addEntry(builder.entryBuilder()
								.startBooleanToggle(new TranslatableText("text.sfcr.option.enableBottomDim")
										, CONFIG.isEnableBottomDim())
								.setDefaultValue(true)
								.setTooltip(new TranslatableText("text.sfcr.option.enableBottomDim.@Tooltip"))
								.setSaveConsumer(CONFIG::setEnableBottomDim)
								.build())
				)
				.setFallbackCategory(builder.getOrCreateCategory(new TranslatableText("text.sfcr.category.density"))
						// threshold
						.addEntry(builder.entryBuilder()
						...
						//night density
						.addEntry(builder.entryBuilder()
								.startIntSlider(new TranslatableText("text.sfcr.option.densityAtNight"),
						...
						.addEntry(builder.entryBuilder()
								...
								.setTextGetter(value -> value == 0 ?
										new TranslatableText("text.sfcr.disabled") :
										new TranslatableText("text.sfcr.second", value)
								)
						...
						//precipitation info
						.addEntry(builder.entryBuilder()
								.startTextDescription(new TranslatableText("text.autoconfig.sfcr.option.precipitationDensity.@PrefixText"))
								.build())
						//snow
						.addEntry(builder.entryBuilder()
								.startIntSlider(new TranslatableText("text.autoconfig.sfcr.option.snowDensity")
						...
						//rain
						.addEntry(builder.entryBuilder()
								.startIntSlider(new TranslatableText("text.autoconfig.sfcr.option.rainPrecipitationDensity")
						...
						//none
						.addEntry(builder.entryBuilder()
								.startIntSlider(new TranslatableText("text.autoconfig.sfcr.option.noneDensity")
				...
				.setFallbackCategory(builder.getOrCreateCategory(new TranslatableText("text.sfcr.category.fog"))
						//fog
						.addEntry(builder.entryBuilder()
						...
						//NO CLOUD NO RAIN
						.addEntry(builder.entryBuilder()
								.startBooleanToggle(new TranslatableText("text.sfcr.option.isCloudRain")
										, CONFIG.isEnableCloudRain())
								.setDefaultValue(false)
								.setTooltip(new TranslatableText("text.sfcr.option.isCloudRain.@Tooltip"))
								.setSaveConsumer(CONFIG::setEnableCloudRain)
								.build())
				)
				.setFallbackCategory(builder.getOrCreateCategory(new TranslatableText("text.sfcr.category.compat"))
						//custom dimension
						.addEntry(builder.entryBuilder()
								.startTextDescription(new TranslatableText("text.sfcr.option.dimensionCompat.@PrefixText",
										(Client.isCustomDimensionConfig ? "§a" : "§c") + dimensionName
								))
								.setTooltip(new TranslatableText("text.sfcr.option.dimensionCompat.@Tooltip"))
								.build())
						//distant horizons
						.addEntry(builder.entryBuilder()
								.startBooleanToggle(new TranslatableText("text.sfcr.option.dHCompat"),
