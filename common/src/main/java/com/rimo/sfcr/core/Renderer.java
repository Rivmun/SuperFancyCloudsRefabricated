...
public class Renderer {
	...
	private static final Runtime RUNTIME = SFCReMod.RUNTIME;
	private static final CommonConfig CONFIG = SFCReMod.COMMON_CONFIG_HOLDER.getConfig();
	...
	//Update Setting.
	public void updateRenderData(CommonConfig config) {
