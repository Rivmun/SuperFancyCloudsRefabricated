...
public class SFCReRenderer {
	...
	private static final SFCReConfig CONFIG = SFCReMain.config;
	...
	public SimplexNoiseSampler cloudNoise = new SimplexNoiseSampler(new SimpleRandom(RUNTIME.seed));
	...
	public void init() {
		cloudNoise = new SimplexNoiseSampler(new SimpleRandom(RUNTIME.seed));
